...
//----------------------------------------------------------------------------------------------
FansElectronics_Bitmap::~FansElectronics_Bitmap()
{
    if (fb)
        free(fb);
}
//----------------------------------------------------------------------------------------------
void FansElectronics_Bitmap::clear(Color color)
{
    unsigned int size = _stride * _height;
    if (color == Black)
        memset(fb, 0xFF, size);
...
//----------------------------------------------------------------------------------------------
void FansElectronics_Bitmap::setPixel(int x, int y, Color color)
{
    if (((unsigned int)x) >= ((unsigned int)_width) ||
        ((unsigned int)y) >= ((unsigned int)_height))
...
//----------------------------------------------------------------------------------------------
void FansElectronics_Bitmap::drawRect(int x1, int y1, int x2, int y2, Color borderColor, Color fillColor)
{
    int temp;
    if (x1 > x2)
    {
...
//----------------------------------------------------------------------------------------------
void FansElectronics_Bitmap::drawText(int x, int y, const char *str, int len)
{
    if (!_font)
        return;
...
//----------------------------------------------------------------------------------------------
void FansElectronics_Bitmap::drawText(int x, int y, const String &str, int start, int len)
{
    if (!_font)
        return;
    uint8_t height = fontHeight(_font);
...
void FansElectronics_Bitmap::drawTextCenter(int max_x, int x, int y, const String &str)
{
    ...
    int pixelChar = (max_x - textWidth(str)) / 2;
    x += pixelChar;
    while (len-- > 0)
    {
        x += drawChar(x, y, str[start++]);
...
//----------------------------------------------------------------------------------------------
int FansElectronics_Bitmap::charWidth(char ch) const
{
    uint8_t index = (uint8_t)ch;
    if (!_font)
        return 0;
...
//----------------------------------------------------------------------------------------------
int FansElectronics_Bitmap::textWidth(const char *str, int len) const
{
    int width = 0;
    if (len < 0)
        len = strlen(str);
...
//----------------------------------------------------------------------------------------------
int FansElectronics_Bitmap::textWidth(const String &str, int start, int len) const
{
    int width = 0;
    if (len < 0)
        len = str.length() - start;
...
//----------------------------------------------------------------------------------------------
int FansElectronics_Bitmap::textHeight() const
{
    if (_font)
...
//----------------------------------------------------------------------------------------------
void FansElectronics_Bitmap::copy(int x, int y, int width, int height, FansElectronics_Bitmap *dest, int destX, int destY)
{
    if (dest == this)
    {
...
//----------------------------------------------------------------------------------------------
void FansElectronics_Bitmap::fill(int x, int y, int width, int height, Color color)
{
    while (height > 0)
    {
...
//----------------------------------------------------------------------------------------------
void FansElectronics_Bitmap::fill(int x, int y, int width, int height, FansElectronics_Bitmap::ProgMem pattern, Color color)
{
...
//----------------------------------------------------------------------------------------------
void FansElectronics_Bitmap::invert(int x, int y, int width, int height)
{
    while (height > 0)
    {
